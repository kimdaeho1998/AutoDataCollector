...
ALIASES: dict[str, str] = {
    ...
    '유부 꼬마김밥 4줄': 'KIMBAP_TOFU_SKIN',
    '불어묵꼬마김밥 4줄': 'KIMBAP_SPICY_FISH_CAKE',
    '선비김치우동': 'KIMCHI_UDON',
    '꼬마김밥 5줄': 'KIMBAP_5',
    '선비꼬마김밥 5줄': 'KIMBAP_5',
    '꼬마김밥 10줄': 'KIMBAP_10',
    ...
    '순한맛 떡볶이': 'TTEOKBOKKI_MILD',
    '떡볶이(순)': 'TTEOKBOKKI_MILD',
    '국물떡볶이(매운맛)': 'TTEOKBOKKI_SPICY',
    '매운맛 떡볶이': 'TTEOKBOKKI_SPICY',
    '떡볶이(매)': 'TTEOKBOKKI_SPICY',
    '순한맛 쫄면': 'JJOLMYEON_MILD',
    '쫄면(순)': 'JJOLMYEON_MILD',
    '매운맛 쫄면': 'JJOLMYEON_SPICY',
    '쫄면(매)': 'JJOLMYEON_SPICY',
...
AMBIGUOUS: dict[str, tuple[str, ...]] = {
    ...
    "쫄면": ("JJOLMYEON_MILD", "JJOLMYEON_SPICY"),
}
